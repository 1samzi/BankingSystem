...
public class AccountService {
    ...
    public Account saveAccount(AccountCreateRequestDTO dto){
        ...
        User user = userRepository.findById(dto.getUserId())
                .orElseThrow(() -> new RuntimeException("Cannot associated user to save account. (User ID:" + dto.getUserId() + ")"));
    ...
    public AccountResponseDTO getAccount(Long id){
         Account account = repo.findById(id)
                 .orElseThrow(() -> new RuntimeException("Account not found for GET request. (ID: " + id + ")"));
    ...
    public Account updateAccount(Long id, AccountUpdateRequestDTO dto){
        Account accountToUpdate = repo.findById(id)
                .orElseThrow(() -> new RuntimeException("Account not found for PATCH request. (ID: " + id + ")"));
